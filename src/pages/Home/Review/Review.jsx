          ...
          <div className="card-body">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="gray font-bold text-center mt-5">
                ...
                happier with my purchase. I will definitely be buying more toys
                from this store!" - Ibrahim S.
              </p>
            </div>
        ...
        <div className="card w-96 bg-base-100 shadow-2xl">
          <div className="card-body">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="gray font-bold text-center mt-5">
                "I've been collecting Marvel superhero toys for years, and this
                website has quickly become my go-to place for all my purchases.
                The selection is incredible, and the customer service is
                top-notch. I recently bought the Iron Man and Captain America
                figures, and they are absolutely fantastic. I highly recommend
                this store to all Marvel enthusiasts!" - Jessica S.
              </p>
            </div>
            <div className="flex gap-4 mt-6 justify-center items-center">
              <FaFacebook />
        ...
        <div className="card w-96 bg-base-100 shadow-2xl">
          <div className="card-body">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="gray font-bold text-center mt-5">
                "I was searching for a special gift for my nephew, who is a huge
                fan of Black Panther. I stumbled upon this website and found the
                perfect Black Panther action figure. The toy arrived on time,
                and the quality was outstanding. My nephew was over the moon
                with joy when he received it. Thank you for making his day!" -
                David L.
              </p>
            </div>
            <div className="flex gap-4 mt-6 justify-center items-center">
          ...
          <div className="card-body">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="gray font-bold text-center mt-5">
                ...
                couldn't be happier. The packaging was excellent, ensuring that
                the toys arrived in perfect condition. The range of characters
                available is impressive, and the website is easy to navigate. I
                appreciate the attention to detail in every toy. This is
                definitely the place to go for any Marvel fan!" - Sarah T.
              </p>
            </div>
            <div className="flex gap-4 mt-6 justify-center items-center">
              <FaFacebook />
          ...
          <div className="card-body">
            <div className="flex flex-col justify-center items-center">
              ...
              <p className="gray font-bold text-center mt-5">
                ...
                highly recommend this store to any Marvel collector!" - Sweet W.
              </p>
            </div>
            <div className="flex gap-4 mt-6 justify-center items-center">
              <FaFacebook />
